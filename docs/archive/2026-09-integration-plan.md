> **Archived (2026-09-25).** This is the integration plan (v1.3) that turned four
> repositories into this monorepo, kept for its reasoning and history. Phases P0–P5 were
> implemented as described; the cutover in §10 was never needed because nothing was
> deployed yet. The current design, status and roadmap are in
> [`../SYSTEM_ARCHITECTURE.md`](../SYSTEM_ARCHITECTURE.md). Links and section numbers
> below refer to this plan as it was.
